 ...
 * de uma matriz dinamica, alocada em duas dimensoes (primeiro 
 * as linhas, depois as colunas).
 *
...
int main(int argc, char *argv[])
{
  ...
  register unsigned int numLinhas, numColunas;
  ...
  matriz = (float **) malloc(sizeof(float*) * numLinhas);
  
  for (i=0; i<numLinhas; i++)
      matriz[i] = (float *) malloc(sizeof(float) * numColunas);
